...
(function () {
     ...
     */
    var URL = window.UEDITOR_HOME_URL || contextPath + '/ui/widgets/ueditor/' || (function(){
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:contextPath + "/manager/component/image_upload.do"             //图片上传提交地址
        ...
        //附件上传配置区
        ,fileUrl:contextPath + "/manager/component/attachment_upload.do"               //附件上传提交地址
        ,filePath:contextPath + "/"                   //附件修正地址，同imagePath
