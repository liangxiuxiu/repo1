...
//排除disabled
var bck=opts.finder.getTr(_12e,"","allbody").addClass("datagrid-row-checked").find("div.datagrid-cell-check input[type=checkbox][disabled!=disabled]");
