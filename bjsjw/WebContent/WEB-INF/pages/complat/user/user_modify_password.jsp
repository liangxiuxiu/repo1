...
<body>
	<div id="breadcrumb">系统设置</div>
	<div id="page-title">修改登陆信息</div>
	<div id="page-content">
		<!--表单主体-->
		<form action="${url}" method="post" id="oprform" name="oprform">
			<table border="0" align="center" class="table">
				...
				<tr>
					...
					<td>
						<input type="text" id="loginname" name="loginname" maxlength="33" class="input-text" value="${loginname }" onpaste="return false" />
						<div><font color="red">用户名不可以带有敏感字符<br>比如：admin,root,sa,sys,dba,manage,system等等</font></div>
					</td>
				</tr>
				<tr>
					...
					<td class="required">*</td>
					<td>
						<input type="password" id="opassword" name="opassword" maxlength="33" class="input-text" />
					</td>
				</tr>
				<tr>
