...
<script>
	...
	function toolbarAction(action) {
		...
		case 'remove':
			...
			break;
		case 'add':
			openDialog('demo/person/add_show.do', 550, 350, {
				title : '新增'
			});
			break;
		case 'edit':

			alert('姓名：' + getCheckedAttr('name') + '<br>学历：' + getCheckedAttr('degree') + '<br>日期：' + getCheckedAttr('create_date'));
			break;
		}
	}

	function edit(iid, name) {
		openDialog('demo/person/modify_show.do?iid=' + iid, 550, 350, {
			title : '修改'
		});
	}
</script>
